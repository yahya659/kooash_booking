...
(function() {
  ...
  /**
   * تهيئة carousel تلقائيًا للـ hero
   */
  document.addEventListener('DOMContentLoaded', function () {
      var heroCarousel = document.querySelector('#hero-carousel');
      if (heroCarousel) {
          new bootstrap.Carousel(heroCarousel, {
              interval: 5000, // الوقت بين الصورة والثانية بالمللي ثانية
              ride: 'carousel', // التشغيل التلقائي
              pause: false      // لا يتوقف عند المرور على الصورة
          });
      }
  });
